...
I've partially parsed QSpice \*.sch/\*.sym files for other projects in the past (e.g., the QCodeGen tool).  This is a fresh start in hopes of fully reverse-engineering the file format.
