...
extern "C" __declspec(dllexport) void pic16f1521x_dll(
  ...
  const char *DevPart = data[9].str;   // input parameter
  double     &RA0_O   = data[10].d;    // output
  double     &RA0_C   = data[11].d;    // output
  double     &RA1_O   = data[12].d;    // output
  double     &RA1_C   = data[13].d;    // output
  double     &RA3_O   = data[14].d;    // output
  double     &RA3_C   = data[15].d;    // output
  double     &RA4_O   = data[16].d;    // output
  double     &RA4_C   = data[17].d;    // output
  double     &RA5_O   = data[18].d;    // output
