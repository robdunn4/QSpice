...
pic16f1827(pInstData *opaque, double t, uData *data) {
    ...
    // Manual modification is not recommended.
     ...
     double      &RA6_O       = data[33].d  ; // output
     bool        &RA6_C       = data[34].b  ; // output
     double      &RA7_O       = data[35].d  ; // output
     bool        &RA7_C       = data[36].b  ; // output
     double      &RB0_O       = data[37].d  ; // output
     bool        &RB0_C       = data[38].b  ; // output
     double      &RB1_O       = data[39].d  ; // output
     bool        &RB1_C       = data[40].b  ; // output
     double      &RB2_O       = data[41].d  ; // output
     bool        &RB2_C       = data[42].b  ; // output
     double      &RB3_O       = data[43].d  ; // output
     bool        &RB3_C       = data[44].b  ; // output
     double      &RB4_O       = data[45].d  ; // output
     bool        &RB4_C       = data[46].b  ; // output
     double      &RB5_O       = data[47].d  ; // output
     bool        &RB5_C       = data[48].b  ; // output
     double      &RB6_O       = data[49].d  ; // output
     bool        &RB6_C       = data[50].b  ; // output
     double      &RB7_O       = data[51].d  ; // output
     bool        &RB7_C       = data[52].b  ; // output
