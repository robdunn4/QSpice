...
pic18f46k22(pInstData *opaque, double t, uData *data) {
     ...
     double       RC3_I       = data[ 21].d  ; // input
     double       RC4_I       = data[ 22].d  ; // input
     double       RC5_I       = data[ 23].d  ; // input
     double       RC6_I       = data[ 24].d  ; // input
     double       RC7_I       = data[ 25].d  ; // input
     double       RD0_I       = data[ 26].d  ; // input
     double       RD1_I       = data[ 27].d  ; // input
     double       RD2_I       = data[ 28].d  ; // input
     double       RD3_I       = data[ 29].d  ; // input
     double       RD4_I       = data[ 30].d  ; // input
     double       RD5_I       = data[ 31].d  ; // input
     double       RD6_I       = data[ 32].d  ; // input
     double       RD7_I       = data[ 33].d  ; // input
     double       RE0_I       = data[ 34].d  ; // input
     double       RE1_I       = data[ 35].d  ; // input
     double       RE2_I       = data[ 36].d  ; // input
     double       RE3         = data[ 37].d  ; // input
     ...
     double      &RA0_O       = data[ 41].d  ; // output
     bool        &RA0_C       = data[ 42].b  ; // output
     double      &RA1_O       = data[ 43].d  ; // output
     bool        &RA1_C       = data[ 44].b  ; // output
     double      &RA2_O       = data[ 45].d  ; // output
     bool        &RA2_C       = data[ 46].b  ; // output
     double      &RA3_O       = data[ 47].d  ; // output
     bool        &RA3_C       = data[ 48].b  ; // output
     double      &RA4_O       = data[ 49].d  ; // output
     bool        &RA4_C       = data[ 50].b  ; // output
     double      &RA5_O       = data[ 51].d  ; // output
     bool        &RA5_C       = data[ 52].b  ; // output
     double      &RA6_O       = data[ 53].d  ; // output
     bool        &RA6_C       = data[ 54].b  ; // output
     double      &RA7_O       = data[ 55].d  ; // output
     bool        &RA7_C       = data[ 56].b  ; // output
     ...
     double      &RC0_O       = data[ 73].d  ; // output
     bool        &RC0_C       = data[ 74].b  ; // output
     double      &RC1_O       = data[ 75].d  ; // output
     bool        &RC1_C       = data[ 76].b  ; // output
     double      &RC2_O       = data[ 77].d  ; // output
     bool        &RC2_C       = data[ 78].b  ; // output
     double      &RC3_O       = data[ 79].d  ; // output
     bool        &RC3_C       = data[ 80].b  ; // output
     double      &RC4_O       = data[ 81].d  ; // output
     bool        &RC4_C       = data[ 82].b  ; // output
     double      &RC5_O       = data[ 83].d  ; // output
     bool        &RC5_C       = data[ 84].b  ; // output
     double      &RC6_O       = data[ 85].d  ; // output
     bool        &RC6_C       = data[ 86].b  ; // output
     double      &RC7_O       = data[ 87].d  ; // output
     bool        &RC7_C       = data[ 88].b  ; // output
     double      &RD0_O       = data[ 89].d  ; // output
     bool        &RD0_C       = data[ 90].b  ; // output
     double      &RD1_O       = data[ 91].d  ; // output
     bool        &RD1_C       = data[ 92].b  ; // output
     double      &RD2_O       = data[ 93].d  ; // output
     bool        &RD2_C       = data[ 94].b  ; // output
     double      &RD3_O       = data[ 95].d  ; // output
     bool        &RD3_C       = data[ 96].b  ; // output
     double      &RD4_O       = data[ 97].d  ; // output
     bool        &RD4_C       = data[ 98].b  ; // output
     double      &RD5_O       = data[ 99].d  ; // output
     bool        &RD5_C       = data[100].b  ; // output
     double      &RD6_O       = data[101].d  ; // output
     bool        &RD6_C       = data[102].b  ; // output
     double      &RD7_O       = data[103].d  ; // output
     bool        &RD7_C       = data[104].b  ; // output
     double      &RE0_O       = data[105].d  ; // output
     bool        &RE0_C       = data[106].b  ; // output
     double      &RE1_O       = data[107].d  ; // output
     bool        &RE1_C       = data[108].b  ; // output
     double      &RE2_O       = data[109].d  ; // output
     bool        &RE2_C       = data[110].b  ; // output
