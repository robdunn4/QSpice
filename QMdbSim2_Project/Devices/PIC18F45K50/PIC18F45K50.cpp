...
pic18f45k50(pInstData *opaque, double t, uData *data) {
     double       VDD         = data[  0].d  ; // input
     double       Dx2B_I      = data[  1].d  ; // input
     double       Dx2D_I      = data[  2].d  ; // input
     double       RA0_I       = data[  3].d  ; // input
     double       RA1_I       = data[  4].d  ; // input
     double       RA2_I       = data[  5].d  ; // input
     double       RA3_I       = data[  6].d  ; // input
     double       RA4_I       = data[  7].d  ; // input
     double       RA5_I       = data[  8].d  ; // input
     double       RA6_I       = data[  9].d  ; // input
     double       RA7_I       = data[ 10].d  ; // input
     double       RB0_I       = data[ 11].d  ; // input
     double       RB1_I       = data[ 12].d  ; // input
     double       RB2_I       = data[ 13].d  ; // input
     double       RB3_I       = data[ 14].d  ; // input
     double       RB4_I       = data[ 15].d  ; // input
     double       RB5_I       = data[ 16].d  ; // input
     double       RB6_I       = data[ 17].d  ; // input
     bool         SIMCLK      = data[ 18].b  ; // input
     double       RB7_I       = data[ 19].d  ; // input
     double       RC0_I       = data[ 20].d  ; // input
     double       RC1_I       = data[ 21].d  ; // input
     double       RC2_I       = data[ 22].d  ; // input
     ...
     double       VUSB3V3     = data[ 37].d  ; // input
     ...
     double      &Dx2B_O      = data[ 41].d  ; // output
     bool        &Dx2B_C      = data[ 42].b  ; // output
     double      &Dx2D_O      = data[ 43].d  ; // output
     bool        &Dx2D_C      = data[ 44].b  ; // output
     double      &RA0_O       = data[ 45].d  ; // output
     bool        &RA0_C       = data[ 46].b  ; // output
     double      &RA1_O       = data[ 47].d  ; // output
     bool        &RA1_C       = data[ 48].b  ; // output
     double      &RA2_O       = data[ 49].d  ; // output
     bool        &RA2_C       = data[ 50].b  ; // output
     double      &RA3_O       = data[ 51].d  ; // output
     bool        &RA3_C       = data[ 52].b  ; // output
     double      &RA4_O       = data[ 53].d  ; // output
     bool        &RA4_C       = data[ 54].b  ; // output
     double      &RA5_O       = data[ 55].d  ; // output
     bool        &RA5_C       = data[ 56].b  ; // output
     double      &RA6_O       = data[ 57].d  ; // output
     bool        &RA6_C       = data[ 58].b  ; // output
     double      &RA7_O       = data[ 59].d  ; // output
     bool        &RA7_C       = data[ 60].b  ; // output
     double      &RB0_O       = data[ 61].d  ; // output
     bool        &RB0_C       = data[ 62].b  ; // output
     double      &RB1_O       = data[ 63].d  ; // output
     bool        &RB1_C       = data[ 64].b  ; // output
     double      &RB2_O       = data[ 65].d  ; // output
     bool        &RB2_C       = data[ 66].b  ; // output
     double      &RB3_O       = data[ 67].d  ; // output
     bool        &RB3_C       = data[ 68].b  ; // output
     double      &RB4_O       = data[ 69].d  ; // output
     bool        &RB4_C       = data[ 70].b  ; // output
     double      &RB5_O       = data[ 71].d  ; // output
     bool        &RB5_C       = data[ 72].b  ; // output
     double      &RB6_O       = data[ 73].d  ; // output
     bool        &RB6_C       = data[ 74].b  ; // output
     double      &RB7_O       = data[ 75].d  ; // output
     bool        &RB7_C       = data[ 76].b  ; // output
     double      &RC0_O       = data[ 77].d  ; // output
     bool        &RC0_C       = data[ 78].b  ; // output
     double      &RC1_O       = data[ 79].d  ; // output
     bool        &RC1_C       = data[ 80].b  ; // output
     double      &RC2_O       = data[ 81].d  ; // output
     bool        &RC2_C       = data[ 82].b  ; // output
     double      &RC6_O       = data[ 83].d  ; // output
     bool        &RC6_C       = data[ 84].b  ; // output
     double      &RC7_O       = data[ 85].d  ; // output
     bool        &RC7_C       = data[ 86].b  ; // output
     double      &RD0_O       = data[ 87].d  ; // output
     bool        &RD0_C       = data[ 88].b  ; // output
     double      &RD1_O       = data[ 89].d  ; // output
     bool        &RD1_C       = data[ 90].b  ; // output
     double      &RD2_O       = data[ 91].d  ; // output
     bool        &RD2_C       = data[ 92].b  ; // output
     double      &RD3_O       = data[ 93].d  ; // output
     bool        &RD3_C       = data[ 94].b  ; // output
     double      &RD4_O       = data[ 95].d  ; // output
     bool        &RD4_C       = data[ 96].b  ; // output
     double      &RD5_O       = data[ 97].d  ; // output
     bool        &RD5_C       = data[ 98].b  ; // output
     double      &RD6_O       = data[ 99].d  ; // output
     bool        &RD6_C       = data[100].b  ; // output
     double      &RD7_O       = data[101].d  ; // output
     bool        &RD7_C       = data[102].b  ; // output
     double      &RE0_O       = data[103].d  ; // output
     bool        &RE0_C       = data[104].b  ; // output
     double      &RE1_O       = data[105].d  ; // output
     bool        &RE1_C       = data[106].b  ; // output
     double      &RE2_O       = data[107].d  ; // output
     bool        &RE2_C       = data[108].b  ; // output
  ...
  if (!inst) {
    ...
    inst->vddName = "VDD";
    inst->mdb.addPinPortMap("D+", &Dx2B_I, &Dx2B_O, &Dx2B_C);
    inst->mdb.addPinPortMap("D-", &Dx2D_I, &Dx2D_O, &Dx2D_C);
    ...
    inst->mdb.addPinPortMap("VUSB3V3", &VUSB3V3);
