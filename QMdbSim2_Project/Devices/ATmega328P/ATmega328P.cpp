...
atmega328p(pInstData *opaque, double t, uData *data) {
    ...
    // Manual modification is not recommended.
     ...
     double       &ADC6        = data[ 1].d  ; // input
     double       &ADC7        = data[ 2].d  ; // input
     double       &AREF        = data[ 3].d  ; // input
     double       &AVCC        = data[ 4].d  ; // input
     double       &PB0_I       = data[ 5].d  ; // input
     double       &PB1_I       = data[ 6].d  ; // input
     double       &PB2_I       = data[ 7].d  ; // input
     double       &PB3_I       = data[ 8].d  ; // input
     double       &PB4_I       = data[ 9].d  ; // input
     double       &PB5_I       = data[10].d  ; // input
     double       &PB6_I       = data[11].d  ; // input
     double       &PB7_I       = data[12].d  ; // input
     double       &PC0_I       = data[13].d  ; // input
     bool         &SIMCLK      = data[14].b  ; // input
     double       &PC1_I       = data[15].d  ; // input
     double       &PC2_I       = data[16].d  ; // input
     double       &PC3_I       = data[17].d  ; // input
     double       &PC4_I       = data[18].d  ; // input
     double       &PC5_I       = data[19].d  ; // input
     double       &PC6         = data[20].d  ; // input
     double       &PD0_I       = data[21].d  ; // input
     double       &PD1_I       = data[22].d  ; // input
     double       &PD2_I       = data[23].d  ; // input
     double       &PD3_I       = data[24].d  ; // input
     double       &PD4_I       = data[25].d  ; // input
     double       &PD5_I       = data[26].d  ; // input
     double       &PD6_I       = data[27].d  ; // input
     double       &PD7_I       = data[28].d  ; // input
     const char * DevPartName = data[29].str; // input parameter
     const char * DevPgmPath  = data[30].str; // input parameter
     const char * CfgIniPath  = data[31].str; // input parameter
     double      &PB0_O       = data[32].d  ; // output
     bool        &PB0_C       = data[33].b  ; // output
     double      &PB1_O       = data[34].d  ; // output
     bool        &PB1_C       = data[35].b  ; // output
     double      &PB2_O       = data[36].d  ; // output
     bool        &PB2_C       = data[37].b  ; // output
     double      &PB3_O       = data[38].d  ; // output
     bool        &PB3_C       = data[39].b  ; // output
     double      &PB4_O       = data[40].d  ; // output
     bool        &PB4_C       = data[41].b  ; // output
     double      &PB5_O       = data[42].d  ; // output
     bool        &PB5_C       = data[43].b  ; // output
     double      &PB6_O       = data[44].d  ; // output
     bool        &PB6_C       = data[45].b  ; // output
     double      &PB7_O       = data[46].d  ; // output
     bool        &PB7_C       = data[47].b  ; // output
     double      &PC0_O       = data[48].d  ; // output
     bool        &PC0_C       = data[49].b  ; // output
     double      &PC1_O       = data[50].d  ; // output
     bool        &PC1_C       = data[51].b  ; // output
     double      &PC2_O       = data[52].d  ; // output
     bool        &PC2_C       = data[53].b  ; // output
     double      &PC3_O       = data[54].d  ; // output
     bool        &PC3_C       = data[55].b  ; // output
     double      &PC4_O       = data[56].d  ; // output
     bool        &PC4_C       = data[57].b  ; // output
     double      &PC5_O       = data[58].d  ; // output
     bool        &PC5_C       = data[59].b  ; // output
     double      &PD0_O       = data[60].d  ; // output
     bool        &PD0_C       = data[61].b  ; // output
     double      &PD1_O       = data[62].d  ; // output
     bool        &PD1_C       = data[63].b  ; // output
     double      &PD2_O       = data[64].d  ; // output
     bool        &PD2_C       = data[65].b  ; // output
     double      &PD3_O       = data[66].d  ; // output
     bool        &PD3_C       = data[67].b  ; // output
     double      &PD4_O       = data[68].d  ; // output
     bool        &PD4_C       = data[69].b  ; // output
     double      &PD5_O       = data[70].d  ; // output
     bool        &PD5_C       = data[71].b  ; // output
     double      &PD6_O       = data[72].d  ; // output
     bool        &PD6_C       = data[73].b  ; // output
     double      &PD7_O       = data[74].d  ; // output
     bool        &PD7_C       = data[75].b  ; // output
  ...
  if (!inst) {
    ...
    inst->vddName = "VCC";
    inst->mdb.addPinPortMap("ADC6", &ADC6);
    inst->mdb.addPinPortMap("ADC7", &ADC7);
