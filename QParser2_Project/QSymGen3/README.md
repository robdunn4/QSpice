...
That said, the code demonstrates a number of techniques to parse text files and generate QSpice symbols and schematics using the QParser2 library.  MSVS project files are included so that you can modify/compile QSymGen3 from sources.
