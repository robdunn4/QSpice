...
int main(int argc, char** argv) {
	...
	// fix uData -- change stack variable copies to references
	uDataLines = UDataFixup::apply(uDataLines);

	// add a local string name for VDD
	if (!pinList.vddPinName.empty()) {
		uDataLines.push_back("const double &vddRef = " + pinList.vddPinName + ";");
	}
	else {
